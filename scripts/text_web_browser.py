...
from scripts.mdconvert import FileConversionException, MarkdownConverter, UnsupportedFormatException
...
if __name__ == "__main__":
    ...
    # Initialize the SimpleTextBrowser
    ...
    visit_result = visit_tool.forward(url)
    print("Page content:\n", visit_result)

    # Example 2: Search for a string on the page
    search_string = "Simon"
    print(f"\nSearching for '{search_string}' on the page...")
    find_result = finder_tool.forward(search_string)
    print("Search result:\n", find_result)

    # Example 3: Find the next occurrence of the search string
    print("\nFinding the next occurrence of the search string...")
    find_next_result = find_next_tool.forward()
